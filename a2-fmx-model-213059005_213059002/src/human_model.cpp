...
#include "human_model.hpp"
#include "humanoid.hpp"

extern csX75::HNode * human_node;
...
void initBuffersGL(void)
{
  ...
  human_node = make_humanoid();
  curr_node = human_node;
}
...
//    glm::mat4 scale_matrix = glm::scale(model_matrix, glm::vec3(2,2,2));

  view_matrix = projection_matrix*lookat_matrix;

  matrixStack.push_back(view_matrix);
    human_node->render_tree();
}
...
int main(int argc, char** argv)
{
  ...
  window = glfwCreateWindow(512, 512, "Assignment 2:FMX Modeling - Rider", NULL, NULL);
  if (!window)
    {
      glfwTerminate();
      return -1;
